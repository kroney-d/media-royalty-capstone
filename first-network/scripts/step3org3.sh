...
# on peer0.artist and peer0.buyer, and uprage the chaincode on the
...
echo "===================== Installing chaincode 2.0 on peer0.artist ===================== "
installChaincode 0 1 2.0
echo "===================== Installing chaincode 2.0 on peer0.buyer ===================== "
installChaincode 0 2 2.0

echo "===================== Upgrading chaincode on peer0.artist ===================== "
